...
parser.add_argument('-nc', '--num_cliques', metavar='NC', type=int, help='num_cliques', nargs='?')
parser.add_argument('-cs', '--clique_size', metavar='CS', type=int, help='clique_size', nargs='?')

args = parser.parse_args()
random.seed(args.seed)

G = eval('nx.' + args.graph, {**globals(), **{'N': args.N, 'M': args.edges, 'P': args.prob, 'K': args.k, 'NC': args.num_cliques,'CS': args.clique_size}}, locals())
