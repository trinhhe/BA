...
do
    ...
    do
        OUT=${file##*/}
        ${DIR}/mincut1 -sf "$file" -n1 -v > ../test/out/mincut1/unweighted/${G}/${OUT%.wel}.csv
        ${DIR}/mincut2 -sf "$file" -n1 -v > ../test/out/mincut2/unweighted/${G}/${OUT%.wel}.csv
        ${DIR}/mincut3 -sf "$file" -n1 -v > ../test/out/mincut3/unweighted/${G}/${OUT%.wel}.csv
        ${DIR}/mincut4 -sf "$file" -n1 -v > ../test/out/mincut4/unweighted/${G}/${OUT%.wel}.csv
